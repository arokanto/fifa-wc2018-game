...
function calculateScores(data, userData) {
  ...
  for (let i = 0; i < userData.length; i++) {
    ...
    if (typeof data.knockout.round_2.matches[0].winner !== 'undefined') {
      // We have a winner
      winner = data.knockout.round_2.matches[0].winner
      if (thisUser.round_1 == winner) {
        scoreObject.positions += 16
      }
    }
